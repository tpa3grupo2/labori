 ...
 * @author Rony_2
 */
public class FrameUniversidade extends javax.swing.JFrame {

	private University universidadeSelecionada;
	private MenuAdmin menuAdmin;
	private FormularioUniversidade formularioUniversidade;
	...
	public University getUniversidadeSelecionada() {
		return universidadeSelecionada;
	}

	public void setUniversidadeSelecionada(University universidadeSelecionada) {
		this.universidadeSelecionada = universidadeSelecionada;
	}
	
	public void atualizarListaUniversidade() {
		initComponents();
	}
	 ...
	 */
	public FrameUniversidade() {
		this.formularioUniversidade = new FormularioUniversidade();
		this.formularioUniversidade.setFrameUniversidade(this);
    ...
    private void initComponents() {
        ...
        universityQuery = java.beans.Beans.isDesignTime() ? null : laboriPUEntityManager.createQuery("SELECT u FROM University u");
        universityList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : universityQuery.getResultList();
        ...
        org.jdesktop.swingbinding.JListBinding jListBinding = org.jdesktop.swingbinding.SwingBindings.createJListBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, universityList, listEmpresa);
	...
	private void btnAdicionarEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarEmpresaActionPerformed
		this.formularioUniversidade.setUniversidade(new University());
		this.formularioUniversidade.mostrarDados();
		this.formularioUniversidade.setVisible(true);
	...
	private void listEmpresaValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listEmpresaValueChanged
		...
		this.universidadeSelecionada = (University) lista.getSelectedValue();
	...
	private void btnEditarEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarEmpresaActionPerformed
		this.formularioUniversidade.setUniversidade(this.universidadeSelecionada);
		this.formularioUniversidade.mostrarDados();
		this.formularioUniversidade.setVisible(true);
		this.setVisible(false);
	...
	private void btnRemoverEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverEmpresaActionPerformed
		if(this.universidadeSelecionada!=null){
			this.universityDao.delete(this.universidadeSelecionada);
			atualizarListaUniversidade();
		}
    ...
    private java.util.List<com.labori.gui.University> universityList;
    private javax.persistence.Query universityQuery;
