...
INSERT INTO FIELD (ID, NAME) VALUES (7, 'Ciências, Pesquisa ');
...
INSERT INTO UNIVERSITY (ID, NAME, ADDRESS, UF_ID) VALUES (3, 'Pontifícia Universidade Católica de São Paulo', 'Rua Marquês de São Vicente 225', 35);

INSERT INTO COMPANY (ID, NAME, CNPJ) VALUES (3, 'Carrefour', '123.123/0001-12');

INSERT INTO JOBVACANCY (ID, NAME, COMPANY_ID, FIELD_ID, SALARY, DESCRIPTION) VALUES (1, 'Auxiliar de administração', 3, 1, 560.34, 'Primeira descrição');
INSERT INTO JOBVACANCY (ID, NAME, COMPANY_ID, FIELD_ID, SALARY, DESCRIPTION) VALUES (2, 'Subauxiliar de administração', 3, 1, 320.20, 'Segunda descrição');
